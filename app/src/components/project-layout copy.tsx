...
export const ProjectLayout: React.FC<Props> = ({ url, duration, regions }) => {
  ...
  return (
    <Flex flexDirection="column" bg="#171717" color="rgb(250, 250, 250)">
      ...
      <Flex flexDirection="column" h="calc(100vh - 64px)">
        <Box flex="1">placeholder area</Box>
        <Box
          h="250px"
          borderTop="1px solid"
        ...
        >
          ...
          >
            ...
            <HStack mt="9" justifyContent="space-between" px="6" align="center">
              <HStack>
